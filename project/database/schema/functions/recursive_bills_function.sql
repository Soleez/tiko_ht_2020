...
BEGIN
    return query
    with recursive bl(bill_id, contract_id, total_sum, billing_address, bill_status_id, bill_due_date, previous_bill_id, handling_fee, tier) as (
        select b.bill_id, cast(b.contract_id as bigint), b.total_sum, 
        b.billing_address,  b.bill_status_id, b.bill_due_date, b.previous_bill_id, bt.handling_fee,1
        from (Bill b join Contract on b.contract_id = Contract.contract_id) join Bill_type bt on bt.bill_type_id = b.bill_type_id
        where contract_type_id = 1 or contract_type_id = 2 
        union
        select b.bill_id, cast(b.contract_id as bigint), b.total_sum, b.billing_address, b.bill_status_id, b.bill_due_date, bl.previous_bill_id, bt.handling_fee, bl.tier + 1
        from ((Bill b join bl on b.previous_bill_id = bl.bill_id) join Contract on b.contract_id = Contract.contract_id)  join Bill_type bt on bt.bill_type_id = b.bill_type_id
...
insert into Bill values
(default, 3, 340, 'osote4', 1, 2, null, null, '2020-01-30', '2020-02-20', );